        ...
        return (skole.length === 0
            ...
            <>
                <div className="boks bla-boks margin-top senter">
                    <h3>Skoler</h3>
                    {skole.barneskolekrets ? <p className="capitalize">Barneskole: <a href={skole.lenkeBarneskole}>{skole.barneskolekrets}</a></p> : ''}
                    {skole.ungdomskolekrets ? <p className="capitalize">Ungdomskole: <a href={skole.lenkeUngdomskole}>{skole.ungdomskolekrets}</a></p> : ''}
                </div>
            </>
        )
    }
